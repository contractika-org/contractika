...
@Component({
  selector: 'serviceaccount',
  templateUrl: 'serviceaccount.component.html',
  styleUrls: ['serviceaccount.component.scss']
})
export class ServiceAccountComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    private default_descriptor: any = {
        ...
        context: {
            entity: 'contractika\\ServiceAccount',
            view:   'form.default'
        }
    };
    ...
    public ngOnDestroy() {
        console.debug('ServiceAccountComponent::ngOnDestroy');
        this.ngUnsubscribe.next();
        this.ngUnsubscribe.complete();
    }

    public ngAfterViewInit() {
        console.debug('ServiceAccountComponent::ngAfterViewInit');

        this.context.setTarget('#sb-container-serviceaccount');
    ...
    public ngOnInit() {
        console.debug('ServiceAccountComponent::ngOnInit');
        ...
        */
        this.route.params.pipe(takeUntil(this.ngUnsubscribe)).subscribe( async (params) => {
            this.sa_id = <number> parseInt(params['service_account_id'], 10);
            if(this.ready) {
                this.default_descriptor.context.domain = ["id", "=", this.sa_id];
