...
export class CustomerComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    private default_descriptor: any = {
        ...
        context: {
            entity: 'contractika\\sale\\customer\\Customer',
            view:   'form.default'
        }
    };
    ...
    public ngAfterViewInit() {
        console.debug('CustomerComponent::ngAfterViewInit');

        this.context.setTarget('#sb-container-customer');
    ...
    public ngOnInit() {
        ...
        */
        this.route.params.pipe(takeUntil(this.ngUnsubscribe)).subscribe( async (params) => {
            this.sa_id = <number> parseInt(params['customer_id'], 10);
            if(this.ready) {
                this.default_descriptor.context.domain = ["id", "=", this.sa_id];
