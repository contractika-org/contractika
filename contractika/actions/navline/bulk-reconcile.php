...
[$params, $providers] = eQual::announce([
    'description'   => "Attempt to reconcile given NAV lines.",
    'params'        => [
        'ids' =>  [
            'description'       => 'Identifiers of the targeted NAV lines to reconcile.',
            'type'              => 'array',
            'required'          => true
        ]
    ],
...
$res = $om->canTransition(NAVLine::getType(), $params['ids'], 'reconcile');
...
$om->transition(NAVLine::getType(), $params['ids'], 'reconcile');
