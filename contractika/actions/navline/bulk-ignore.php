...
[$params, $providers] = eQual::announce([
    ...
    'params'        => [
        'ids' =>  [
            'description'       => 'Identifiers of the targeted NAV lines to ignore.',
            'type'              => 'array',
            'required'          => true
        ]
    ],
...
$res = $om->canTransition(NAVLine::getType(), $params['ids'], 'ignore');
...
$om->transition(NAVLine::getType(), $params['ids'], 'ignore');
